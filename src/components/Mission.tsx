      ...
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center space-y-8 md:space-y-12">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="w-16 md:w-20 h-1 bg-blue/30 mx-auto rounded-full" />
          </div>
          
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 text-left">
            <div className="card card-interactive">
              <h3 className="text-lg md:text-xl font-semibold text-blue-dark mb-3">{t("mission.challenge.title")}</h3>
            ...
            <div className="card card-interactive">
              <h3 className="text-lg md:text-xl font-semibold text-blue-dark mb-3">{t("mission.solution.title")}</h3>
              <p className="text-sm md:text-base text-gray leading-relaxed">
