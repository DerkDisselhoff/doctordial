    ...
    <section className="py-20 px-4 bg-surface">
      <div>
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-primary-light/10 px-4 py-2 rounded-full border border-primary/20 mb-8">
            <Shield className="w-4 h-4 text-primary" />
            <span className="text-primary text-sm font-medium">Trained on medical data</span>
          </div>
          <h3 className="text-3xl font-bold mb-8 text-text-primary">Trained on data from Dutch Healthcare Institutions</h3>
          
          <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
            <div className="p-6 rounded-xl bg-surface-secondary border border-surface-input space-y-4 hover:border-primary/20 transition-colors">
              <div className="relative group h-32 flex items-center justify-center">
                <div className="absolute -inset-0.5 bg-primary/20 rounded-lg blur opacity-30 group-hover:opacity-50 transition-opacity" />
                <img
