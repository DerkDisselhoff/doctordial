    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-nav">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-2">
          <span className="text-2xl font-bold bg-gradient-to-r from-mint to-white bg-clip-text text-transparent">
            SmartGP Connect
          </span>
          <span className="hidden md:inline-block text-sm text-mint/80">
            AI-Powered Patient Call Management
          </span>
        </Link>
