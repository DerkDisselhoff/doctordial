    ...
    <div className="relative flex items-center h-8 overflow-hidden">
      ...
      >
        {duplicatedSymptoms.map((symptom, index) => (
          <span
            key={`${symptom}-${index}`}
            className="px-3 py-1 text-xs font-medium rounded-full bg-mint/10 text-gray-dark border border-mint/20 flex items-center gap-2 hover:bg-mint/20 transition-colors"
          >
...
export default SarahSymptomTags;