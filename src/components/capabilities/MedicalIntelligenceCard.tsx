  ...
  return (
    <div className="mb-6 relative h-48">
      ...
      >
        ...
        <div className="absolute left-1/2 top-[25%] -translate-x-1/2 -translate-y-1/2 w-16 h-16">
          <img
        ...
        <div className="absolute left-1/2 top-[60%] -translate-x-1/2 flex items-center gap-4">
          {/* U1 Badge */}
          <motion.div
