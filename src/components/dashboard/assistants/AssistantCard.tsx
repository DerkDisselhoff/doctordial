...
import { Bot, Phone, Settings, Pill, Microscope, Clock, BarChart, AlertCircle } from "lucide-react";
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray">
              Weet je zeker dat je de {title.toLowerCase()} assistent wilt uitschakelen? 
