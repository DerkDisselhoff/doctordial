...
export const nlTranslations = {
  ...
  sarah: {
    ...
    step3Title: "Integreer HIS/EPD",
    step3Description: "Activeer Sarah om naadloos te integreren met jouw Huisarts Informatie Systeem of Elektronisch Patiënten Dossier, zodat alle patiëntcommunicatie correct wordt gedocumenteerd en gesynchroniseerd.",
