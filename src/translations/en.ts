export const enTranslations = {
  ...
  sarah: {
    ...
    step3Title: "Integrate with your EHR",
    step3Description: "Activate Sarah to seamlessly integrate with your Electronic Health Record system, ensuring all patient communications are properly documented and synchronized.",
