...
import { TriageSettings as TriageSettingsComponent } from "@/components/dashboard/assistants/settings/TriageSettings";
    ...
    try {
      ...
      if (session) {
        ...
        toast({
          ...
          description: `De triage assistent is nu ${status ? 'actief' : 'inactief'}.`,
  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-3xl font-bold text-gray-dark">Triage Assistent Instellingen</h2>
          </div>
          <p className="text-gray">Beheer de instellingen en werkstroom van de Triage Assistent</p>
        </div>
      ...
      <Card className="border-gray-muted shadow-sm">
        ...
        <CardContent>
          <TriageSettingsComponent onSettingChange={handleSettingChange} />
        </CardContent>
      </Card>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray">
              Weet je zeker dat je de triage assistent wilt uitschakelen? 
...
export default TriageSettingsPage;
