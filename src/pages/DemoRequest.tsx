...
const DemoRequest = () => {
  ...
  return (
    <div className="min-h-screen pt-24 bg-mint/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col lg:flex-row lg:items-start lg:gap-16">
        ...
        <div className="lg:w-[45%] mb-8 lg:mb-0 lg:sticky lg:top-8">          
          <div className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-forest mb-6">{t("demo.subtitle")}</h1>
          ...
          <div className="bg-forest rounded-xl border border-mint/10 p-8 shadow-lg">
