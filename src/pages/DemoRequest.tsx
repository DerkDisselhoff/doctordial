...
const DemoRequest = () => {
  ...
  return (
    <div className="min-h-screen bg-forest">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex flex-col lg:flex-row lg:items-start lg:gap-16">
        {/* Left side content */}
        <div className="lg:w-[45%] mb-8 lg:mb-0 lg:sticky lg:top-8">          
          <div className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">{t("demo.subtitle")}</h1>
          ...
          <div className="bg-forest-dark rounded-xl border border-mint/10 p-8 shadow-lg backdrop-blur-sm">
