  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Dashboard basic insights",
        "Koppeling HIS",
        "Verificatie geboorte datum/naam",
        "Email opvolging",
      ],
    },
    {
      name: "Scale",
      title: "Grote praktijk",
      price: "€2.499",
      ...
      features: [
        ...
        "Verificatie geboorte datum/naam",
        "Email opvolging",
        "Aanpassingen gedragsprotocol doktorsassistent",
        "Eigen stem kiezen",
      ],
    },
    {
      ...
      features: [
        ...
        "Aanpassingen gedragsprotocol doktorsassistent",
        "Eigen stem kiezen",
        "Sentiment analyse van de gesprekken",
        "Custom koppelingen met eigen systemen",
      ],
    },
  ];
